...
// ============================================================================
// Valida o módulo SelfTest que testa: ADC, EEPROM, FLASH, NVS,
// Current Sensor, Temperature Sensor, MOSFET Driver e RAM.
//
...
// Testa que o resultado inicial é NOT_RUN
...
// Testa que run() retorna PASS no ambiente mock
...
// Testa que todos os componentes individuais passam
...
// Testa que o self test é determinístico (executa 2x e passa)
